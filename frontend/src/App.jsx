...
function App() {
  ...
  useEffect(() => {
    ...
    newSocket.on("ready", () => {
      ...
      addLog(
        "success",
        "✅ App de mensajería conectada y listo para enviar encuestas!",
      );
    });
    ...
    newSocket.on("loading", (data) => {
      addLog(
        "info",
        `📊 App de mensajería cargando: ${data.percent}% - ${data.message}`,
      );
    });
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Envía encuestas a múltiples grupos
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                {isConnected
                  ? isWhatsAppReady
                    ? "✅ App de mensajería Listo"
                    : "⏳ Conectando App de mensajería..."
                  : "❌ Sin conexión"}
              </span>
            </div>
          </div>
            ...
            <div className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
              ...
              {qrCode && !isWhatsAppReady && (
                <div className="text-center">
                  <p className="text-gray-300 mb-4">
                    Escanea este código QR con App de mensajería
                  </p>
                  ...
                  <div className="mt-4 space-y-2">
                    <p className="text-sm text-gray-400">
                      1. Abre App de mensajería en tu teléfono
                    </p>
                    <p className="text-sm text-gray-400">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  💡 Escribe los nombres exactos de los grupos tal como aparecen
                  en tu app de mensajería
                </p>
              </div>
